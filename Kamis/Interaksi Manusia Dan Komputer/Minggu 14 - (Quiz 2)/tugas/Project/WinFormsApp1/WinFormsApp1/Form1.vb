Public Class Form1
    ...
    Private Sub Luncurkan()
		...
		MsgBox("Nama Lengkap Harus berupa huruf tidak boleh simbol atau angka kecuali min, titik, koma dan tanda petik tunggal ",vbOKOnly + MessageBoxIcon.Error, "Peringatan")
		...
		MsgBox("Tempat Lahir Harus berupa huruf tidak boleh simbol atau angka kecuali min, titik, koma dan tanda petik tunggal ",vbOKOnly + MessageBoxIcon.Error, "Peringatan")
		...
		MsgBox("Alamat Harus berupa huruf tidak boleh simbol atau angka kecuali min, titik, koma dan tanda petik tunggal ",vbOKOnly + MessageBoxIcon.Error, "Peringatan")
